...
module.exports = {
  ...
  'Page de publications': function(client) {
    ...
    client.expect.element('.publications tr:nth-child(1) .annee').text.to.contains('2019')
    client.expect.element('.publications tr:nth-child(1) .mois').text.to.contains('January')
    client.expect.element('.publications tr:nth-child(1) .pubtitle').text.to.contains('Mining Concept Map from Text in Portuguese')
    client.expect.element('.publications tr:nth-child(1) .authors').text.to.contains('Camila Zacche de Aguiar, Davidson Cury, Alphonsine Beauchamps')
    client.expect.element('.publications tr:nth-child(1) .venue').text.to.contains('Brazilian Journal of Computers in Education 27.01')
    client.expect.element('.publications tr:nth-child(10) .annee').text.to.contains('2016')
    client.expect.element('.publications tr:nth-child(10) .mois').text.to.contains('June')
    client.expect.element('.publications tr:nth-child(10) .pubtitle').text.to.contains('Automatic Extraction of Axioms from Wikipedia Using SPARQL')
    client.expect.element('.publications tr:nth-child(10) .authors').text.to.contains('Joey Gelinas, Alphonsine Beauchamps, Michel Deslauriers')
    client.expect.element('.publications tr:nth-child(10) .venue').text.to.contains('ESWC-16 Open Knowledge Extraction Challenge, Heraklion, Greece')
