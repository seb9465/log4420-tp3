...
module.exports = {
  ...
  'Page de publications': function(client) {
    ...
    client.expect.elements('.publications tr:nth-child(1)').text.to.contain('2019')
    client.expect.elements('.publications tr:nth-child(1)').text.to.contain('Janvier')
    client.expect.elements('.publications tr:nth-child(1)').text.to.contain('Mining Concept Map from Text in Portuguese')
    client.expect.elements('.publications tr:nth-child(1)').text.to.contain('Camila Zacche de Aguiar, Davidson Cury, Alphonsine Beauchamps')
    client.expect.elements('.publications tr:nth-child(1)').text.to.contain('Brazilian Journal of Computers in Education 27.01')
    client.expect.elements('.publications tr:nth-child(10)').text.to.contain('2016')
    client.expect.elements('.publications tr:nth-child(10)').text.to.contain('Juillet')
    client.expect.elements('.publications tr:nth-child(10)').text.to.contain('Automatic Extraction of Axioms from Wikipedia Using SPARQL')
    client.expect.elements('.publications tr:nth-child(10)').text.to.contain('Joey Gelinas, Alphonsine Beauchamps, Michel Deslauriers')
    client.expect.elements('.publications tr:nth-child(10)').text.to.contain('ESWC-16 Open Knowledge Extraction Challenge, Heraklion, Greece')
